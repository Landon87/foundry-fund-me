 ...
 * @notice This contract is used to fund the contract with ETH
 */
...
contract FundMe {
    ...
    //Costants are changeable at compile time
    //Immutable are changeable at deploy time
    ...
    function fund() public payable {
        AggregatorV3Interface(s_priceFeedAddress).latestRoundData();
        require(
            PriceConverter.getConversionRate(msg.value, 
            AggregatorV3Interface(s_priceFeedAddress)) >= MINIMUM_USD, 
